...
`application/x.infinitec.transaction+json;version=2`. For incompatible changes, a new
...
[source,http]
----
Accept: application/x.infinitec.transaction+json;version=2
----
...
[source,http]
----
Content-Type: application/x.infinitec.transaction+json;version=2
----
