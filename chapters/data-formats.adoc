...
Some might consider the use of custom media types like
`application/x.infinitec.payment+json`. This usage is not recommended
and should be avoided, except where it is necessary for cases of
