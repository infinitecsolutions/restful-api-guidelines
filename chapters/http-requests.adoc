...
[#X001]
== {SHOULD} Provide PATCH Endpoint Along PUT One

For client's convenience provide PATCH endpoint along PUT one, allowing
selective update of the resource.

////
Comments:
Wilerson: Don't know: I'm a fan of the spirit of this proposition, not sure
