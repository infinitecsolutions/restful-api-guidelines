...
assess if query-by-example using query parameters or OData doesn't meet the
requirements.

=== Query-by-Example Using Query Parameters

Query-by-example using query parameters works by introducing a query parameter
